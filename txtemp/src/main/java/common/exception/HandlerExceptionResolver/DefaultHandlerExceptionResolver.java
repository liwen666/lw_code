package common.exception.HandlerExceptionResolver;
...
//	private static Logger logger = LoggerFactory.getLogger(DefaultHandlerExceptionResolver.class);
  ...
  public static void main(String[] args) {
	 System.out.println(Exception.class.isAssignableFrom(ServiceException.class)); 
	 System.out.println(ServiceException.class.isAssignableFrom(Exception.class)); 
}
...
//		logger.error("系统异常："+ExceptionUtils.getFullStackTrace(ex));
		...
		exceptionModel.put("errorMsg",ex.getMessage());
		exceptionModel.put("errorType",ex.getClass().getName());
		ex.printStackTrace();
