...
public class cache {
    ...
    //private static final String JDBC_URL = "jdbc:h2:tcp://127.0.0.1/E:/H2/gacl";;MVCC=TRUE"
	/**
	 * <property name="url" value="jdbc:h2:mem:gacl"/>
	 */
//    private static final String JDBC_URL = "jdbc:h2:mem:tcp://127.0.0.1:8043/c:/Users/pc/Desktop/独立部署工作流/h2db/testbpmn";
	 private static final String JDBC_URL = "jdbc:h2:tcp://127.0.0.1:8043/mem:testbpmn"; //;DB_CLOSE_ON_EXIT=FALSE";//    private static final String JDBC_URL = "jdbc:h2:tcp://127.0.0.1:8043/c:/Users/pc/Desktop/独立部署工作流/h2db/testbpmn";
//    private static final String JDBC_URL = "jdbc:h2:tcp://127.0.0.1:8043/c:/Users/pc/Desktop/独立部署工作流/h2db/testbpmn;FILE_LOCK=NO";
//    private static final String JDBC_URL = "jdbc:h2:tcp://127.0.0.1/c:/Users/pc/Desktop/独立部署工作流/h2db/testbpmn;AUTO_SERVER=TRUE";
