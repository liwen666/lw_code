...
public class Cluster {
    ...
    static {
        ...
        // 添加节点
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3791));
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3792));
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3793));
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3794));
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3795));
        hostAndPortsSet.add(new HostAndPort("192.168.100.109", 3796));
...
//        jedisPoolConfig.setMaxTotal(500);
    ...
    public void testKey() throws InterruptedException {
        ...
        System.out.println(keys("use*"));
        /**
         * 判断key在哪个节点上
         */
        String nodeIpAndPort = getAddr("username");
        String nodeIpAndPort2 = getAddr("membership:user:user001");
        System.out.println(nodeIpAndPort);
        System.out.println(nodeIpAndPort2);
    }

    private String getAddr(String username) {
