...
public class ParseAnnotation {
    ...
    public static void parseTypeAnnotation() throws ClassNotFoundException{
        Class clazz = Class.forName("com.temp.code.interannotation.demo1.UserAnnotation");
    ...
    private static void parseMethod() throws InstantiationException, IllegalAccessException{
    	UserAnnotation uannotion = UserAnnotation.class.newInstance();
