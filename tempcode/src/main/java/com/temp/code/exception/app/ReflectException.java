...
public class ReflectException extends Exception {
	...
	public ReflectException(String errCode, String errMessage) {
		super(errMessage);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	public ReflectException(String errCode, String errMessage,Throwable e) {
		super(errMessage,e);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReflectException other = (ReflectException) obj;
		if (errCode == null) {
