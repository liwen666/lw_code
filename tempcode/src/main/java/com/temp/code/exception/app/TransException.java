...
public class TransException extends Exception {
	...
	public TransException(String errCode, String errMessage) {
		super(errMessage);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	public TransException(String errCode, String errMessage,Throwable e) {
		super(errMessage,e);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TransException other = (TransException) obj;
		if (errCode == null) {
	...
	public String toString() {
		return "TransException [errCode=" + errCode + ", errMessage=" + errMessage + "]";
	}
