...
public class ControlerException extends Exception {
	...
	public ControlerException(String errCode, String errMessage) {
		super(errMessage);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	public ControlerException(String errCode, String errMessage,Throwable e) {
		super(errMessage,e);
		this.errCode = errCode;
		this.errMessage = errMessage;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ControlerException other = (ControlerException) obj;
		if (errCode == null) {
