 ...
 */
public class CheckContionPO implements Serializable{
    ...
    public static CheckContionPO newObj(String checkResultID,String deid,String deidVal,String conTotalNum){
    	CheckContionPO po =new CheckContionPO();
