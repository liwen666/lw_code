 ...
 */
public class AuditRuleColPO implements  Serializable{
	/**
	 * 
	 */
	...
	public AuditRuleColPO(String name, String colDbName, int datatype,boolean needCDATA) {
		this.setName(name);
	...
	public AuditRuleColPO(String name, String colDbName, int datatype,boolean needCDATA,boolean isVirtual) {
		this.setName(name);
		this.setColDbName(colDbName);
		this.setDatatype(datatype);
		this.setNeedCDATA(needCDATA);
	...
	public AuditRuleColPO(String name, String colDbName, int datatype,String csTabName,boolean needCDATA) {
		this.setName(name);
		this.setColDbName(colDbName);
		this.setDatatype(datatype);
	...
	public AuditRuleColPO(String name, String colDbName, int datatype,String csTabName,boolean needCDATA,boolean isVirtual) {
		this.setName(name);
		this.setColDbName(colDbName);
		this.setDatatype(datatype);
		this.setCsTabName(csTabName);
