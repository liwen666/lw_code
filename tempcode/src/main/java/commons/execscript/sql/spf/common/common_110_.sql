CREATE OR REPLACE PROCEDURE P_TRANSPOSE_ZCXMMXB_SPF(P_SRC_TABLEID VARCHAR2,P_BILLDEFID VARCHAR2,P_TABLEID VARCHAR2) IS
...
UNPIVOT(AMT FOR FUNDSOURCEGUID IN('||V_TMP||'))';
  ...
  RETURN;
END P_TRANSPOSE_ZCXMMXB_SPF;

--P_TRANSPOSE_ZCXMMXB_SPF
