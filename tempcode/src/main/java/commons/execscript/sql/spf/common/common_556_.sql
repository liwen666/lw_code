...
insert into dict_t_defaultcol (DEALID, ORDERID, NAME, DBCOLUMNNAME, DATATYPE, DATALENGTH, SCALE, CSID, ISPRIMARY, ISRESERVE, GUID, STATUS, DBVERSION, DEFAULTVALUE, ISLOGICKEY, DEID, ISVISIBLE, ISUPDATE)
values ('A0*04', 11, '关联ID', 'REALID', 3, 32, 0, null, '0', '0', '1238F696D989691DE050A8C02105513A', '1',sysdate(), null, '0', null, '0', '0');

delete from dict_t_defaultcol where guid = '233BD911234B7D98E050A8C021054B4E';                                                                                                                                                                                                         
insert into dict_t_defaultcol (DEALID, ORDERID, NAME, DBCOLUMNNAME, DATATYPE, DATALENGTH, SCALE, CSID, ISPRIMARY, ISRESERVE, GUID, STATUS, DBVERSION, DEFAULTVALUE, ISLOGICKEY, DEID, ISVISIBLE, ISUPDATE) 
values ('A0*04', 12, '项目名称', 'XMXSL', 3, 500, 0, null, '0', '1', '233BD911234B7D98E050A8C021054B4E', '1', sysdate(), null, '0', null, '0', '0');

end;--20170307控制数表-初始化数据(修改后)
