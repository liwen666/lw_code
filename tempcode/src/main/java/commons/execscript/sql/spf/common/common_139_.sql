  ...
  BEGIN
    ...
    select * from (
        select i.PROJECTID,
               ...
               (case when 
                      a.DISTRICTID=f.DISTRICTID  and a.isleaf  ='1' and a.isdistrict = '0' and  a.divtype='0'  then p.AGENCYID
                    when
                      a.DISTRICTID=f.DISTRICTID  and a.isleaf = '1' and a.isdistrict = '0' and (a.divtype = '3' or a.divtype = '4')  then f.FIRAGENCYID
                    when 
                      a.DISTRICTID<>f.DISTRICTID and a.isleaf = '1' and a.isdistrict = '0' then a.DISTRICTID
                end) AGENCYID,  
                                  
                (case when 
                      a.DISTRICTID=f.DISTRICTID  and a.isleaf  ='1' and a.isdistrict = '0' and  a.divtype='0' then '1'
                    when
                      a.DISTRICTID=f.DISTRICTID  and a.isleaf = '1' and a.isdistrict = '0' and (a.divtype = '3' or a.divtype = '4') then '2'
                    when 
                      a.DISTRICTID<>f.DISTRICTID and a.isleaf = '1' and a.isdistrict = '0' then '3'
                end) DEALTYPE, 
