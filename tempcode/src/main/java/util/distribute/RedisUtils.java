...
//            //获取槽号
//            int slot = JedisClusterCRC16.getSlot(getHashKey(RedisKeyPrefixConstant.PROCESS_INSTANCE, proceInsMap.getValue().getBpmnType(), proceInsMap.getKey()));
//            if (slot == 0) slot = 1;
